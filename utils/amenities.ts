...
export const amenities: Amenity[] = [
  { name: "unlimites cloud storage", icon: FiCloud, selected: false },
  ...
  { name: "private bathroom (bushes neraby)", icon: FiCoffee, selected: false },
  ...
  {
    name: "air conditiong (breeze from the west)",
    icon: FiBox,
    selected: false,
  },
  { name: "bed lines (leaves)", icon: FiAnchor, selected: false },
  ...
  { name: "solar poer (daylight )", icon: FiSunset, selected: false },
  ...
  {
    name: "first aid kit (hope and prayers)",
    icon: FiTv,
    selected: false,
  },
];
...
export const conservativeAmenities: Amenity[] = [
  { name: "could storage", icon: FiCloud, selected: false },
  { name: "parking", icon: FiTruck, selected: false },
  { name: "fire plit", icon: FiZap, selected: false },
  ...
  { name: "hot showwer", icon: FiFeather, selected: false },
  ...
  { name: "picnic tables", icon: FiMapPin, selected: false },
  { name: "hammock", icon: FiSunrise, selected: false },
  { name: "solar power", icon: FiSunset, selected: false },
  { name: "water suply", icon: FiMusic, selected: false },
